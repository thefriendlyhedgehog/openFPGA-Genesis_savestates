...
module excUnit( input s_clks Clks,
	...
	// Save-state: snapshot all 68K registers
	// Packed as 18 x 32-bit words: regs[0]=D0 ... regs[7]=D7, regs[8]=A0 ... regs[14]=A6,
	// regs[15]=USP, regs[16]=SSP, regs[17]=DT; plus PC (32b)
	output logic [575:0] ss_regs_out,  // 18 × 32b register file
	output logic [31:0]  ss_pc_out,    // {PcH, PcL}
...
// synthesis translate on
	...
	// -----------------------------------------------------------------
	// Save-state: continuous output of register file and PC
	// -----------------------------------------------------------------
	genvar ss_i;
	generate
		for (ss_i = 0; ss_i < 18; ss_i++) begin : ss_reg_assign
			assign ss_regs_out[ss_i*32 +: 32] = {regs68H[ss_i], regs68L[ss_i]};
		end
	endgenerate
