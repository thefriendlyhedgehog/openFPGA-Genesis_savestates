...
// synchronous to clk_74a
    ...
    // savestate_start_ack/busy/ok/err driven from savestate_ctrl via CDC below
...
wire        ss_load_ack_sys,  ss_load_busy_sys,  ss_load_ok_sys,  ss_load_err_sys;
wire        ss_halt;

// CDC: ack/busy/ok/err back from clk_sys → clk_74a
synch_3 ss_save_ack_s  (ss_save_ack_sys,  savestate_start_ack,  clk_74a);
synch_3 ss_save_busy_s (ss_save_busy_sys, savestate_start_busy, clk_74a);
synch_3 ss_save_ok_s   (ss_save_ok_sys,   savestate_start_ok,   clk_74a);
synch_3 ss_save_err_s  (ss_save_err_sys,  savestate_start_err,  clk_74a);
synch_3 ss_load_ack_s  (ss_load_ack_sys,  savestate_load_ack,   clk_74a);
synch_3 ss_load_busy_s (ss_load_busy_sys, savestate_load_busy,  clk_74a);
synch_3 ss_load_ok_s   (ss_load_ok_sys,   savestate_load_ok,    clk_74a);
synch_3 ss_load_err_s  (ss_load_err_sys,  savestate_load_err,   clk_74a);

// Savestate data_unloader: serves APF reads from 0x50000000
wire        ssr_en;
wire [17:0] ssr_addr;
wire  [7:0] ssr_data;
...
// Savestate data_loader: receives APF writes at 0x50000000
wire        ssw_en;
wire [17:0] ssw_addr;
wire  [7:0] ssw_data;
...
wire         ss_z80ram_we;
wire  [7:0]  ss_z80ram_di, ss_z80ram_do;
wire [63:0]  ss_psg_state;
...
wire [255:0] ss_vdp_reg;
wire  [31:0] ss_vdp_state;
wire  [15:0] ss_vdp_status;
...
savestate_ctrl ssctrl (
    .clk        (clk_sys),
    .reset      (reset),

    .save_start (ss_save_start_s),
    .load_start (ss_load_start_s),
    .save_ack   (ss_save_ack_sys),
    .save_busy  (ss_save_busy_sys),
    .save_ok    (ss_save_ok_sys),
    .save_err   (ss_save_err_sys),
    .load_ack   (ss_load_ack_sys),
    .load_busy  (ss_load_busy_sys),
    .load_ok    (ss_load_ok_sys),
    .load_err   (ss_load_err_sys),
    ...
    .ss_vdp_reg         (ss_vdp_reg),
    .ss_vdp_state       (ss_vdp_state),
    .ss_vdp_status      (ss_vdp_status),
